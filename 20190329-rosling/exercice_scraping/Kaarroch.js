...
const thumbnails = cheerio('.thumbnail', page) //J'utilise cheerio pour directement récupérer toutes les classes thumbnails, qui elles contiennent les noms, les prix et les étoiles que je veux pour chaque produit.
...
const liste = Array.from(thumbnails).map(ordinateur => ({
  produit:getNom(ordinateur), //J'affiche le produit
